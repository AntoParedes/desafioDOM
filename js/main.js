...
const productosEnVenta = [
    { id: 001, nombre: "TV", categoria: "TV", img: "./productos/bgh32.jpg", marca: "BGH", descripcion: "Televisor LED Smart de 32 HD (1366 x 768). Formato de pantalla 16:9. Frecuencia de barrido 60Hz. Radio contraste 1200. Brillo 180 CD/M2. Tiempo de respuesta 8ms Wi Fi", stock: 6, precio: 43900 },

    { id: 002, nombre: "Lavarropas automático", categoria: "Lavarropas", img: "./productos/lavarropasDrean.jpg", marca: "Drean", descripcion: "Clase AA. Cap.6 Kg. Display Led. Carga Autoadaptativa. Sist.Autobalance. 29 Alternativas de lavado. Puerta extra grande. Ciclos especificos de lavado. Antiarrugas. Lavado rapido. Lavado de 1/2 hr. Eco Wash. Hand Wash. Control de temperatura. 600RPM.", stock: 6, precio: 84000 },

    { id: 003, nombre: "Celular A22", categoria: "Celular", img: "./productos/celularA22.jpg", marca: "Samsung", descripcion: "Celular 5G de 6.6' FHD+ (1080 x 2408) TFT. Procesador Octa Core (2.2 GHz, 2GHz). Camara principal 48 + 5 + 2mp. Digital Zoom hasta 10x. Camara frontal 8mp. Capacidad 128 Gb / RAM 4 Gb.", stock: 6, precio: 58000 },

    { id: 004, nombre: "Celular XXX", categoria: "Celular", img: "", marca: "Samsung", descripcion: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugit eius ratione cum, atque quibusdam doloremque, iure repellendus voluptates quos odio exercitationem, deserunt illo aliquid! Beatae est minima rem deleniti voluptatibus.", stock: 6, precio: 60000 },

    { id: 005, nombre: "Celular ZZZ", categoria: "Celular", img: "", marca: "Motorola", descripcion: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugit eius ratione cum, atque quibusdam doloremque, iure repellendus voluptates quos odio exercitationem, deserunt illo aliquid! Beatae est minima rem deleniti voluptatibus.", stock: 6, precio: 56000 },

    { id: 006, nombre: "Caloventor", categoria: "Calefaccion", img: "", marca: "Liliana", descripcion: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugit eius ratione cum, atque quibusdam doloremque, iure repellendus voluptates quos odio exercitationem, deserunt illo aliquid! Beatae est minima rem deleniti voluptatibus.", stock: 6, precio: 8000 },

    { id: 0010, nombre: "XXX", categoria: "calefaccion", img: "", marca: "Liliana", descripcion: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugit eius ratione cum, atque quibusdam doloremque, iure repellendus voluptates quos odio exercitationem, deserunt illo aliquid! Beatae est minima rem deleniti voluptatibus.", stock: 6, precio: 15000 },
